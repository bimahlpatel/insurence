...
<!-- Hero Section Start -->
            ...
            <div class="row gy-5 gy-lg-0 align-items-center justify-content-between">
                <div class="col-12 col-lg-6">
                    <div class="section__content">
                        <span class="section__content-sub-title headingFour wow fadeInDown" data-wow-duration="0.8s"><img src="assets/images/title_vector.png" alt="vector"> Compare and Choose the Best Primium</span>
                        <h1 class="section__content-title display-3 wow fadeInUp" data-wow-duration="0.8s">Protect What Matters Most with Comprehensive Insurance Solutions
                        </h1>
                        <p class="section__content-text wow fadeInDown" data-wow-duration="0.8s">From auto and home to life and business insurance, we provide personalized coverage that gives you peace of mind and financial security when you need it most.</p>
                        <div class="btn-group mt_40 wow fadeInUp" data-wow-duration="0.8s">
                            <a href="<?php echo base_url() ?>" class="btn_theme btn_theme_active">Get Your Free Quote Today<i class="bi bi-arrow-up-right"></i><span></span></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-9 col-xxl-8">
                    <div class="section__header">
                        ...
                        <h2 class="section__header-title wow fadeInUp" data-wow-duration="0.8s">Our Most Popular Coverage Options</h2>
                        <p class="section__header-content wow fadeInDown" data-wow-duration="0.8s">Here's compelling Featured Services content that highlights your most important insurance offerings and drives customer engagement.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="feature_slider wow fadeInUp" data-wow-duration="0.8s">
                        <div class="card card--custom">
                            ...
                            <div class="card__content">
                                <h4 class="card__title"><a href="service-details.html">Motor Insurance</a></h4>
                                <p class="fs-small"> Comprehensive vehicle protection designed for today's drivers. Our auto insurance goes beyond basic liability to offer collision, comprehensive, and uninsured motorist coverage that keeps you protected on every journey.</p>
                        ...
                        <div class="card card--custom">
                            ...
                            <div class="card__content">
                                <h4 class="card__title"><a href="service-details.html">Life Insurance</a></h4>
                                <p class="fs-small">Secure your family's financial future with flexible life insurance options that grow with your needs. Choose from term, whole, or universal life policies designed to provide lasting peace of mind.</p>
                        ...
                        <div class="card card--custom">
                            ...
                            <div class="card__content">
                                <h4 class="card__title"><a href="service-details.html">Health Insurance</a></h4>
                                <p class="fs-small">Navigate healthcare with confidence through our individual and family health insurance plans. Access quality care while protecting yourself from unexpected medical expenses.</p>
                                <a href="service-details.html" class="btn_theme social_box btn_bg_white"><i class="bi bi-arrow-up-right"></i><span></span></a>
                            </div>
                        </div>
            ...
            <div class="row gy-5 gy-lg-0 justify-content-between align-items-center section">
                ...
                <div class="col-12 col-lg-7 col-xxl-6">
                    <div class="section__content ms-lg-4 ms-xl-0">
                        ...
                        <h2 class="section__content-title wow fadeInUp" data-wow-duration="0.8s">Why Choose Us for Your Insurance Needs</h2>
                        <p class="section__content-text wow fadeInDown" data-wow-duration="0.8s">Decades of experience, personalized service, and unmatched local expertise you can trust</p>
                        <div class="section__content-inner wow fadeInUp" data-wow-duration="0.8s">
                            <ul>
                                <li><i class="bi bi-check2-circle"></i> Decades of Trusted Experience</li>
                                <li><i class="bi bi-check2-circle"></i> Personalized Service, Not One-Size-Fits-All</li>
                                <li><i class="bi bi-check2-circle"></i> Competitive Rates with Top Carriers</li>
                                <li><i class="bi bi-check2-circle"></i> Claims Advocacy You Can Count On</li>
                                <li><i class="bi bi-check2-circle"></i> Local Expertise, Personal Accountability</li>
                                <li><i class="bi bi-check2-circle"></i> 24/7 Support and Digital Convenience</li>
                                <li><i class="bi bi-check2-circle"></i> No-Pressure Education</li>
                                <li><i class="bi bi-check2-circle"></i> Proven Customer Satisfaction</li>
                            </ul>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-6 col-xxl-5">
                    <div class="section__header">
                        ...
                        <h2 class="section__header-title wow fadeInUp" data-wow-duration="0.8s">Simplified Steps to Find Your Ideal Insurence</h2>
                        <p class="section__header-content ch-xxl wow fadeInDown" data-wow-duration="0.8s">Our working process is designed to make your insurence search and selection as seamless as possible.</p>
                    </div>
                </div>
            </div>
            <div class="row g-2 g-md-4  wow fadeInUp" data-wow-duration="0.8s">            
                <div class="col-12 col-sm-6 col-xxl-3">
                    <div class="card card--custom">
                        ...
                        <div class="card__content">
                            <h4 class="card__title">Initial Consultation</h4>
                            <p class="fs-small"> We start with a no-obligation consultation to understand your unique needs, current coverage gaps, and budget considerations. Our licensed agents ask the right questions to identify your specific risks and protection priorities.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-xxl-3">
                    <div class="card card--custom">
                        ...
                        <div class="card__content">
                            <h4 class="card__title">Research & Quote Development</h4>
                            <p class="fs-small">Our team researches multiple carriers to find the best coverage options for your situation. We compare rates, benefits, and policy terms from our network of A-rated insurance companies.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-xxl-3">
                    <div class="card card--custom">
                        ...
                        <div class="card__content">
                            <h4 class="card__title">Proposal Review</h4>
                            <p class="fs-small">We present your personalized insurance proposals in plain English, explaining coverage details, costs, and benefits. You'll understand exactly what each policy covers and why we recommend specific options.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-xxl-3">
                    <div class="card card--custom">
                        ...
                        <div class="card__content">
                            <h4 class="card__title">Policy Selection & Setup</h4>
                            <p class="fs-small">Once you choose your coverage, we handle all the paperwork and coordination with your chosen carrier. We ensure your new policy is properly structured and activated on your preferred start date.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row gy-5 gy-lg-0 justify-content-between align-items-center">
                <div class="col-12 col-lg-7 col-xxl-6">
                    <div class="section__content ms-lg-4 ms-xl-0">
                        ...
                        <h2 class="section__content-title wow fadeInUp" data-wow-duration="0.8s">Your Trusted Source for Insurance Solutions and Protection</h2>
                        <p class="section__content-text wow fadeInDown" data-wow-duration="0.8s">Direct parallel to your example, emphasizing comprehensive service.</p>
                        <div class="section__content-inner">
                            <div class="card card--small wow fadeInUp" data-wow-duration="0.8s">
                                ...
                                <div class="card--small-content">
                                    <h5 class="card--small-title">Integrity First</h5>
                                    <p class="card--small-text">We conduct business with complete honesty and transparency. You'll never encounter hidden fees, misleading terms, or pressure tactics. Our recommendations are always based on your best interests, not our profits.</p>
                                </div>
                            </div>
                            <div class="card card--small wow fadeInUp" data-wow-duration="0.8s">
                                <div class="card--small-icon">
                                ...
                                <div class="card--small-content">
                                    <h5 class="card--small-title">Personal Relationships</h5>
                                    <p class="card--small-text">Every client receives individual attention from licensed professionals who take time to understand your specific needs, circumstances, and goals. We're not a call center—we're your neighbors.</p>
                                </div>
                            </div>
                            <div class="card card--small wow fadeInUp" data-wow-duration="0.8s">
                                <div class="card--small-icon">
                                ...
                                <div class="card--small-content">
                                    <h5 class="card--small-title">Expert Knowledge</h5>
                                    <p class="card--small-text">Our team consists of experienced insurance professionals who stay current with industry changes, regulations, and emerging risks to provide you with informed guidance and comprehensive protection.</p>
                                </div>
                            </div>
                            <div class="card card--small wow fadeInUp" data-wow-duration="0.8s">
                                <div class="card--small-icon">
                                ...
                                <div class="card--small-content">
                                    <h5 class="card--small-title">Community Commitment</h5>
                                    <p class="card--small-text">As a locally-owned business, we're invested in our community's success. We sponsor local events, support area nonprofits, and contribute to causes that make our neighborhood stronger.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row gy-5 gy-xl-0 justify-content-between align-items-center">
                <div class="col-12 mx-auto mx-lg-0">
                    <div class="calculator-input">
                        ...
                        <h3 class="contact__title wow fadeInDown mb-4" data-wow-duration="0.8s">Get in touch with us.</h3>
    ...
    <!-- faq start -->
    <section class="section download-app" id="faqa">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-7 col-xxl-6">
                    <div class="section__header">
